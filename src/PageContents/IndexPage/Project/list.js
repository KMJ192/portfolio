  ...
  },
  {
    ...
    perf: [
      ...
      },
      {
        ...
        text: 'react-query',
        exp: [
          '기존에 사용하던 코드는 컴포넌트에서 단순히 API 통신을 위한 함수를 통해 응답을 받고 처리하던 프로세스였고, 유지보수 및 리팩토링 단계에서 지속된 코드의 변경으로 스파게티처럼 복잡한 상태',
          'react-query가 지원하는 캐싱 처리, 상태(로딩, 성공, 실패) 관리, 불필요한 중복 요청 방지 등의 기능을 사용하여 사용자 경험 개선 및 API 요청 / 응답 컨벤션을 체계화',
